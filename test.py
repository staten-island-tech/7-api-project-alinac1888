...
#         self.fish_amoun = fishamoun
#         self.fish = ['tuna', 'salmon', 'sea bass', 'boot', 'squid', 'goldfish', 'red carp', 'fish poop', 'pike']
#         self.chances = [1, 3, 3, 5, 2, 4, 4, 5, 1]

#     def choose_fish(self):
#         import random
#         return random.choices(self.fish, weights=self.chances, k=1)[0]
...
#         """Fetch villagers from Nookipedia API dynamically."""
#         url = "https://api.nookipedia.com/villagers"
#         try:
#             response = requests.get(url, headers=headers)
...
#         villager_file = "villager_placeholder.png"
#         img = Image.open(villager_file).resize((80, 80))
...
#                 for _ in range(50):
#                     self.canvas.move(fish_sprite, 0, -2)
#                     self.canvas.update()
#                     self.canvas.after(20)
#                 self.canvas.delete(fish_sprite)
#             except:
#                 pass
